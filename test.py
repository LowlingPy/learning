...
# T it's mean total coin and P its your pph

t = int(input('Enter your Total coins: '))
p = int(input('Enter your PPH: '))

while True:
    a = int(input('Enter card price:'))
    b = int(input('Enter card profit:'))
    now = t * p
    maybe = (t - a) * (p + b)
    if now < maybe:
        print('Buy')
    elif now > maybe:
        print('Do Not recommended')
